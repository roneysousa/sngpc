object frmManuEstoque: TfrmManuEstoque
  Left = 286
  Top = 184
  ...
  object Panel1: TPanel
    ...
    object rgUnidade: TRadioGroup
      ...
      Width = 185
      Height = 57
      Caption = '[ Unidade Medida Medicamento ]'
      Items.Strings = (
        'Caixas'
        'Frascos')
      TabOrder = 10
  ...
  object dsEstoque: TDataSource
    DataSet = dmDados.cdsEstoqueHistorico
